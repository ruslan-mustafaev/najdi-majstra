                ...
                {!isOwnProfile && !isUserMaster && (
                  <>
                    {!user ? (
                      ...
                      !reviews.some(r => r.client_id === user.id) && (
                        <button
              ...
              <div className="mt-6 space-y-3">
                ...
                {isOwnProfile ? (
                  <button className="w-full bg-blue-500 text-white py-3 rounded-lg font-medium hover:bg-blue-600 transition-colors flex items-center justify-center space-x-2">
                    <Mail size={20} />
                    <span>Zobraziť ako Dashboard</span>
                  </button>
                ) : (
                  <a href={`mailto:${master.email}`} className="w-full bg-blue-500 text-white py-3 rounded-lg font-medium hover:bg-blue-600 transition-colors flex items-center justify-center space-x-2">
                    <Mail size={20} />
                  ...
                  <div className="flex flex-wrap gap-3 items-end">
                    ...
                    {(master as any).socialTelegram && (
                      <a
                        ...
                        title="Telegram"
                      >
                        <img src="/svg_social/telegram_svg.svg" alt="Telegram" className="w-9 h-9" />
                      </a>
                    )}
