...
export const MasterDashboard: React.FC<MasterDashboardProps> = ({ onBack, onProfileUpdate }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-16">
      {/* Header */}
      <div className="bg-gradient-to-r from-[#4169e1] to-[#5a7bff] text-white">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-2xl font-bold">Majster Dashboard</h1>
            <div className="flex items-center space-x-4">
              <span className="text-white/90">Vitajte!</span>
            </div>
          </div>
        </div>
      </div>
