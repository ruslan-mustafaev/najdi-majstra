            ...
            <div className="border-2 border-gray-200 rounded-xl p-6 hover:border-[#4169e1] transition-all duration-200 cursor-pointer group bg-gradient-to-br from-white to-gray-50">
              <div className="text-center">
                ...
                <button
                  onClick={() => handleOptionSelect('master')}
                  disabled={!cookiesAccepted}
                  className="w-full bg-green-500 text-white py-3 rounded-lg font-medium hover:bg-green-600 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed text-base shadow-md hover:shadow-lg min-h-[56px] flex items-center justify-center mt-12"
                >
                  {t.popup.masterOption.button}
                </button>
              </div>
